...
_C.MODEL.BOTTOMUP_FUSE = CN()
_C.MODEL.BOTTOMUP_FUSE.NAME = 'build_resnet_fuse'
_C.MODEL.BOTTOMUP_FUSE.CORE_LAYER = 1

_C.MODEL.RELATION_HEAD = CN()
_C.MODEL.RELATION_HEAD.NAME = 'build_relation_head'
_C.MODEL.RELATION_HEAD.POOLER_EXPAND_RATIO = 2
_C.MODEL.RELATION_HEAD.POOLER_RESOLUTION = 7
_C.MODEL.RELATION_HEAD.POOLER_SCALES = (0.125,)
_C.MODEL.RELATION_HEAD.POOLER_SAMPLING_RATIO = 2
_C.MODEL.RELATION_HEAD.MLP_HEAD_DIM = 1024
_C.MODEL.RELATION_HEAD.FEATURE_NUM = 4
_C.MODEL.RELATION_HEAD.Relation_Unit_Nums = 8
...
_C.MODEL.FPN.IN_STRIDES = []
_C.MODEL.FPN.IN_CHANNELS = []
...
_C.MODEL.ROI_BOX_HEAD.PERSON_HEAD = ""
...
_C.MODEL.ROI_MASK_HEAD.NUM_CONV = 2  # The number of convs in the mask head
_C.MODEL.ROI_MASK_HEAD.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_MASK_HEAD.NORM = "GN"
